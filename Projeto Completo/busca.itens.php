...
<body class="bg-white">
    ...
    <div class="container">
        ...
        <h4 class="mt-5 mb-1 text-center text-secondary">Retirar Itens</h4>
        
        <div class="row justify-content-center">
        
            <div class="col-md-4">
            
                  <form action="" method="get" enctype="multipart/form-data" class="mt-5 px-4 py-4">
    ...
    <?php
        ...
        $consultaBanco = mysqli_query($conn, "SELECT * FROM compras WHERE id = '$id' AND id_status='retirar' ") or die (mysql_error());
        ...
        if($verificaBanco == 1)
        {
            ...
            $sqlRead = "SELECT * FROM compras WHERE id=:id AND id_status='retirar' ";
        ...
        <div class="row justify-content-center">
         ...
         <div class="col-lg-4 col-md-4 col-sm-6 mt-4">
                    ...
                    <div class="card main-card bg-dark text-white px-4 py-4">
                        ...
                        <form action="php/functions/func-retirar-compra.php" method="get" enctype="multipart/form-data">
                            ...
                            <td>
                                <center>
                                    <button type="submit" class="btn btn-dark mt-3 mb-3" name="BtnRetirar" value="Retirar">Retirar</button>
                                </center>    
                            </td>
