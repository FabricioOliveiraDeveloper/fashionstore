             ...
             <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link text-white" href="#">
                        ...
                        <span class="ml-2 nav-text-perfil"><?php echo $_SESSION['cod'];?> <?php echo $_SESSION['sobrenome'];?></span> 
    ...
    <nav class="nav-options bg-roxo">
        ...
        <div class="container">
            ...
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                ...
                <a class="nav-item nav-link" href="user.index.php">
                ...
                <a class="nav-item nav-link active" href="user.index02.php">
    ...
    <section id="Conteudo">
        ...
        <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane fade show active" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                    ...
                    <h5 class="mt-5 text-secondary">Iten(s) retirado(s)</h5>
                            ...
                            <div class="card py-5 px-5 user-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card-text">
                                        ...
                                        <h5 class="card-text-status text-success">
                                            <strong>
                                            Status: 
