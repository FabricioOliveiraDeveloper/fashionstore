...
<!-- Dev: Fabricio Oliveira Template: FashionStore -->
    ...
    <?php
        ...
        if(isset($_POST['BtnCadastrar']))
        {
            ...
            $consultaBancoID = mysqli_query($conn, "SELECT * FROM usuarios WHERE cod = '$cod'") or die (mysql_error());
                            ...
                            <div class="alert alert-danger alert-dismissible mt-5" role="alert">
                                    ...
                                    <center>    
                                        ...
                                        <p>
                                            ...
                                            Prezado(a) <strong><?php echo $nome;?></strong>
                                        ...
                                        <p><a href='loja.cadastro.php'>Preencha novamente</a> e informe um novo endereço.<br><br> Obrigado!</p>
    ...
    <?php                
            ...
            
            {
                ...
                $consultaBanco = mysqli_query($conn, "SELECT * FROM usuarios WHERE email = '$email'") or die (mysql_error());
                ...
                //--Slide1-//	
                    ...
                    if(file_exists("php/files/usuarios_perfil/$slide"))
                    {
                        ...
                        if(move_uploaded_file($_FILES['slide']['tmp_name'],"php/files/usuarios_perfil/".$slide))
                        {
                            ...
                            $insereDados = mysqli_query($conn, "INSERT INTO usuarios(cod,nome,sobrenome,slide,cpf,telefone,email,senha,cep,rua,bairro,cidade,uf,numero)values('$cod','$nome','$sobrenome','$slide','$cpf','$telefone','$email','$senha','$cep','$rua','$bairro','$cidade','$uf','$numero')") or die (mysql_error());
                        }
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="alert alert-success alert-dismissible mt-5" role="alert">
                            ...
                            <center>
                                <p>
                                    Cadastro realizado com sucesso Sr(a),
                                    <strong><?php echo $nome;?></strong>
                                    <strong><?php echo $sobrenome;?></strong>
                                ...
                                <p>Agora realize o <a href="loja.login.php">Login</a> para ultilizar os nossos serviços</p>
    ...
    <section id="Login">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-6 col-md-12">
                ...
                <img class="img-login" src="dist/img/banners/login/banner2.svg" />
                
            </div>
            
            
            <div class="col-lg-5 col-md-4 col-sm-8 col-10 form">
            
                <form action="" method="post" enctype="multipart/form-data" class="py-5 mt-5" accept-charset="ISO-8859-1">
