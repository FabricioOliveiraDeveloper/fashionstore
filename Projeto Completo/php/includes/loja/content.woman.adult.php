...
<!-- Dev: Fabricio Oliveira Template: FashionStore -->
  ...
  <section id="Conteudo">
       ...
       <div class="banner b-index">
                ...
                <div class="b-fem-adult"></div>

                <div class="container">
                    <h5 class="b-title"># Itens Adultos Femininos</h5>
                </div>    
        ...
        <div class="container">
            ...
            <?php
                ...
                $sqlRead = "SELECT * FROM produtos WHERE modelo='Feminino' AND tipo='adulto' ORDER BY id Desc";
