...
<!-- Dev: Fabricio Oliveira Template: FashionStore -->
  ...
  <section id="Conteudo">
       ...
       <div class="banner b-index">
                ...
                <div class="b-fem-inf"></div>

                <div class="container">
                    <h5 class="b-title"># Itens Infantis Femininos</h5>
                </div>    
        ...
        <div class="container">
            ...
            <?php
                ...
                $sqlRead = "SELECT * FROM produtos WHERE modelo='Feminino' AND tipo='infantil' ORDER BY id Desc";
