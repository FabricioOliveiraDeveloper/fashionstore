...
<!-- Dev: Fabricio Oliveira Template: FashionStore -->
  ...
  <section id="Conteudo">
       ...
       <div class="banner b-index">
                ...
                <div class="b-masc-infantil"></div>

                <div class="container">
                    <h5 class="b-title"># Itens Infantins Masculinos</h5>
                </div>    
        ...
        <div class="container">
            ...
            <?php
                ...
                //Seleciona os arquivos da tabela sql
                 $sqlRead = "SELECT * FROM produtos WHERE modelo='Masculino' AND tipo='infantil' ORDER BY id Desc";
