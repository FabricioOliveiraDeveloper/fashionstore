                ...
                <div class="col-md-8 col-sm-8 col-12">
                    ...
                    <div class="card card-form-cad">    
                        ...
                        <div class="mt-4 mb-4 text-center">
                            ...
                            <h6 class="box-title">Nome do Produto: ( <?php echo $rs->nome; ?> )</h6>
                        ...
                        <div class="form-group d-none">
                            ...
                            <!-- Input Nome -->
                            <input type="text" class="d-none form-control" value="<?php echo $rs->cod; ?>" name="cod" required/>
                        ...
                        <div class="form-group">
                            ...
                            <!-- Input Nome -->
                            <input type="text" class="form-control" value="<?php echo $rs->nome; ?>" name="nome" required />
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo $rs->categoria; ?>" name="categoria" required />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <!-- Input Preço --> 
                            <label>Preço</label>
                            <input type="text" class="form-control" value="<?php echo $rs->preco; ?>" name="preco" id="money" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" cols="30" rows="5" name="descricao" required style="resize:none;"><?php echo $rs->descricao; ?>
                            </textarea>
                        ...
                        <input type="submit" class="form-control btn btn-success mt-3" value="Postar" name="BtnEditar">
