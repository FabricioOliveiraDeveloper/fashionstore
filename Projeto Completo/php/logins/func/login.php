...
<?php
    ...
    session_start();
	   ...
	   if(isset($_POST['BtnLogin'])){
		...
		$consultaInformacoes = mysqli_query($conn, "SELECT * FROM funcionarios WHERE email = '$email' AND senha = '$senha'") or die (mysql_error());
        ...
        {
            header('location:funcionarios.login.erro.php');
            die();
        }
