...
<body>
    ...
    <div class="container mt-4">
        ...
        <?php
            ...
            $sqlRead = "SELECT * FROM funcionarios ORDER BY id DESC";
            try
            {
        ...
        ?> 
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mt-4">
                ...
                <div class="card main-card bg-white text-white px-3 py-3">
                    ...
                    <center>
                        <a class="btn btn-primary" href="dashboard.funcionarios.edit.php?id=<?php echo $rs->id ?>">
                 ...
                 <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="text-center">  
                            ...
                            <a class="btn btn-danger text-white" href="php/functions/funcionarios-remove.php?id=<?php echo $rs->id ?>">Sim</a>
